      ...
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn
            color="primary"
            text
            @click="(addNewModal = false), addNewAccessories()"
          >
            Add New</v-btn
          >
        </v-card-actions>
      ...
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn
            color="error"
            text
            @click="(deleteModal = false), deletedAccessories()"
          >
            Delete
          </v-btn>
        </v-card-actions>
...
export default {
  ...
  methods: {
    addNewAccessories() {
      ...
      this.$store.commit("addNewAccessories", lnb);
    },
    deletedAccessories() {
      this.$store.commit("deleteAccessories", this.deletedCategory);
    },
    sale() {
      let lnb = {
        category: this.category,
      ...
      this.$store.commit("saleAccessories", lnb);
    },
    add() {
      let lnb = {
        category: this.category,
      ...
      this.$store.commit("restockAccessories", lnb);
    },
  },
};
</script>
